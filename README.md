...
<div align="center">
  <img src="./public/logo.svg" alt="TranscodeMatrix — FFmpeg — Codecs" width="64" height="64">
  <h1>TranscodeMatrix — FFmpeg — Codecs</h1>
</div>

An independent project specification for FFmpeg, covering codec test matrix, quality comparison notes, output verification manifest.
...
<img src="./public/screenshots/desktop-main.svg" alt="FFmpeg — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="FFmpeg — compact concept, not a screenshot" width="250">
<br>
...
- **Codec test matrix** — planned module; not implemented.
- **Quality comparison notes** — planned module; not implemented.
- **Output verification manifest** — planned module; not implemented.

The proposed workflow separates codec test matrix from quality comparison notes, with output verification manifest retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Codec test matrix**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TranscodeMatrix — FFmpeg — Codecs — specification review workflow">
<br>
...
Define the input and expected outcome for module 1. Record the FFmpeg version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Quality comparison notes

Define the input and expected outcome for module 2. Record the FFmpeg version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Output verification manifest

Define the input and expected outcome for module 3. Record the FFmpeg version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Codec test matrix |
